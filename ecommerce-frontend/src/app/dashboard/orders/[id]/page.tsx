...
export default function DashboardOrderDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link href="/dashboard/orders" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Articles ({order.items?.length || 0})</h2>
          ...
          {/* Status update */}
          <div className="bg-white rounded-xl shadow-sm p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Mettre à jour le statut</h2>
            <div className="space-y-3">
        ...
        <div className="space-y-6">
          ...
          {order.delivery_person && (
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="font-bold mb-3 flex items-center gap-2"><Truck className="h-4 w-4" /> Livreur</h3>
              <p className="text-sm font-medium">{order.delivery_person.name}</p>
              <p className="text-xs text-gray-500">{order.delivery_person.email}</p>
            </div>
          )}
          ...
          {order.address && (
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="font-bold mb-3 flex items-center gap-2"><MapPin className="h-4 w-4" /> Adresse</h3>
              <p className="text-sm">{order.address.full_name} - {order.address.phone}</p>
              <p className="text-xs text-gray-500">{order.address.street_address}, {order.address.quarter}</p>
